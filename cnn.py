...
class CNN(object):
    ...
    def __init__(self, deploy='/home/seonhoon/Desktop/caffemodel/vgg16/VGG_ILSVRC_16_layers_deploy.prototxt', 
                       model='/home/seonhoon/Desktop/caffemodel/vgg16/VGG_ILSVRC_16_layers.caffemodel'):
        caffe.set_mode_gpu()
    ...
    def get_features(self, filelist, layer='fc7'):
        ...
        img_height, img_width, _ = imread(filelist[0]).shape
